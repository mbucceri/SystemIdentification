...
class SimplifiedKinematicParams:
    ...
    """
    gearbox_reduction_ratio: float = 20.0
    screw_pitch: float = 0.005  # [m/rev]
...
class SimplifiedDynamicParams:
    ...
    """
    equivalent_mass: float = 10.0       # M_eq [kg]
    load_mass: float = 10.0             # M_load [kg], for gravity
    current_force_gain: float = 70.0 # K_f [N/A]
