...
@dataclass
class GearboxParams:
    reduction_ratio: float = 10.0       # N = omega_motor / omega_screw
...
@dataclass
class EncoderParams:
    motor_encoder_noise_std: float = 0.0    # [rad]
    linear_encoder_noise_std: float = 0.0   # [m]
...
class VerticalJointParams:
    ...
    controller: MotorControllerParams = field(default_factory=MotorControllerParams)
    motor: MotorParams = field(default_factory=MotorParams)
    gearbox: GearboxParams = field(default_factory=GearboxParams)
    screw: LinearScrewParams = field(default_factory=LinearScrewParams)
    end_effector: EndEffectorParams = field(default_factory=EndEffectorParams)
